        ...
        <div class="policy-stack">
            <div class="policy-card">
                <div class="text-center mb-3">
                    ...
                    <h1 class="policy-title mt-3">Privacy Policy</h1>
                ...
                <div class="policy-section">
                    ...
                    <p>We collect resident information needed to process registrations, requests, and barangay services.</p>
                </div>

                <div class="policy-section">
                    <h2>2. How We Use Data</h2>
                    <p>Your information is used to verify identity, process requests, and improve delivery of official services.</p>
                </div>

                <div class="policy-section">
                    <h2>3. Data Protection</h2>
                    <p>We apply security controls to protect your personal information from unauthorized access and misuse.</p>
                </div>

                <div class="policy-section">
                    <h2>4. Data Sharing</h2>
                    <p>Information is shared only when authorized by law, required for public service, or with your consent.</p>
                </div>

                <div class="policy-section mb-0">
                    <h2>5. Your Rights</h2>
                    <p>You may request access or correction of your personal information through official barangay channels.</p>
                </div>
            </div>
