...
-- Complete Database Import Script for Barangay 219
-- This file combines database creation, schema, and initial data seeding
-- Created: 2025
...
('Juan', 'Dela', 'Cruz', '1990-01-15', 'male', 'married', '123 Main Street, Barangay 219, Tondo, Manila', 'Filipino', 'active'),
('Maria', 'Santos', 'Garcia', '1985-05-20', 'female', 'married', '456 Oak Avenue, Barangay 219, Tondo, Manila', 'Filipino', 'active'),
('Pedro', 'Reyes', 'Lopez', '1992-08-10', 'male', 'single', '789 Pine Road, Barangay 219, Tondo, Manila', 'Filipino', 'active');

-- Sample household
INSERT INTO households (family_head_id, address, total_members, registration_date) VALUES
(1, '123 Main Street, Barangay 219, Tondo, Manila', 1, CURDATE());
